        ...
        this.galaxyTypeButton = new RunnableTextButton("Galaxy type", Styles.getInstance().buttonStyle, () -> {
            ...
            for (MapData map : maps) {
                ...
                RunnableTextButton textButton = new RunnableTextButton(Objects.requireNonNull(mapName), Styles.getInstance().buttonStyle, (mapButton) -> {
                    ...
                    // TODO update preview
                    // TODO selected map button should be in a different color
                });
            ...
            // TODO Don't do that when it has already been done once before
...
//        this.getContentTable().add(options).right().bottom().pad(8F);
//        this.getContentTable().add(this.galaxyPreview).left().top().grow().pad(8F);
...
//        this.getContentTable().add(this.masterSplitPane);
//        this.masterSplitPane.setSplitAmount(0);
//        this.masterSplitPane.setFirstWidget(this.contentTableUpper);
    }
